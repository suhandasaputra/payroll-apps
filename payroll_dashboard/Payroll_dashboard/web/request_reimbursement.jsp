<%-- 
    Document   : request_reimbursement
    Created on : May 22, 2023, 12:10:52 PM
    Author     : azzam
--%>
...
<html lang="en">
    <head>
        ...
        <style>
            <%@include file="/mycss/request_reimbursement.css"%>
        </style>

        <script type="text/javascript" src="myjs/request_reimbursement.js"></script>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="tab-content">
                                                    <div id="request" class="tab-pane fade in active show">                                                        
                                                        ...
                                                        <br>
                                                        <br>
                                                        <table class="table" id="table_requestreimbursement" style="width: 100%; font-size: 12px;">
                                                            <thead>  
                                                                <tr>
                                                                    <th>Ref</th> 
                                                                    <th>Employee ID</th>                                                                     
                                                        ...
                                                        <%@include file='pop_up_approve_request_reimbursement.jsp'%>
                                                    </div>
                                                </div>    
                                            </div>
                                            <!-- /.row -->
