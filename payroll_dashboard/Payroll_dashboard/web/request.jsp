...
<html lang="en">
    <head>
        ...
        <style>
            <%@include file="/mycss/request.css"%>
        </style>

        <script type="text/javascript" src="myjs/request.js"></script>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="tab-content">
                                                    <div id="request" class="tab-pane fade in active show">                                                        
                                                        ...
                                                        <br>
                                                        <br>
                                                        <table class="table" id="table_request" style="width: 100%; font-size: 12px;">
                                                            <thead>  
                                                                <tr>
                                                                    <th>Ref</th> 
                                                                    <th>Employee ID</th> 
                                                        ...
                                                        <%@include file='pop_up_approve_request.jsp'%>
                                                    </div>
                                                </div>    
                                            </div>
                                            <!-- /.row -->
