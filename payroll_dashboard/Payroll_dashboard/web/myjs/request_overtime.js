...
function loaddata() {
    ...
    $('#table_requestovertime').dataTable().fnClearTable();
    $('#table_requestovertime').dataTable().fnDestroy();
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.resp_code == 0000) {
                ...
                $('#table_requestovertime').DataTable({
                    "scrollX": true,
                    "data": datauser,
                    "columns": [
                        {data: "reference",
                    ...
                    "createdRow": function (row, data, dataIndex) {
                        ...
                        if (data.approve_status_head == 'APPROVED') {
                            ...
                            $(row).addClass('red');
                        } else if (data.approve_status_admin == null) {
                            $(row).addClass('yellow');
                        }
                    },
                    dom: 'Bfrtip',
