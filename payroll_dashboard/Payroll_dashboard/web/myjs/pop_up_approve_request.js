...
$('#table_request').on('click', 'td', function () {
        ...
        $.ajax({
            ...
            success: function (resp) {
                if (resp.resp_code == 0000) {
                    ...
                    document.getElementById("date_absensi_detail_request").value = resp.date_absensi;
                    ...
                    document.getElementById("checkin_detail_request").value = resp.checkin;
                    document.getElementById("checkout_detail_request").value = resp.checkout;
                    document.getElementById("desc_detail_request").value = resp.description;
                    document.getElementById("schema_detail_request").value = resp.schema;
...
function sub_approve() {
    ...
    var date_absensi = document.getElementById("date_absensi_detail_request").value;
    var schema = document.getElementById("schema_detail_request").value;
    ...
    if (reference == "") {
        ...
        if (employee_id == "") {
            ...
            datjson.schema = schema;

            var level_desc = window.localStorage.getItem('level_desc');
            if (level_desc !== 'head') {
                $.ajax({
                    dataType: "json",
                    url: "RequestApproveAdmin",
                    data: JSON.stringify(datjson),
                    type: 'post',
                ...
                datjson2.date_absensi = date_absensi;
                datjson2.schema = schema;
                $.ajax({
                    dataType: "json",
                    url: "RequestApproveHead",
