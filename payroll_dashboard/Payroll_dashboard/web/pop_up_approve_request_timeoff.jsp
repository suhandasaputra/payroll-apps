...
<style>
    <%@include file="/mycss/pop_up_approve_request_timeoff.css"%>
</style>

<script type="text/javascript" src="myjs/pop_up_approve_request_timeoff.js"></script>

<div class="cd-popup-edit-user" role="alert">
    <div class="cd-popup-edit-user-container" style="color: #8915e1;">
        <label id="label_edit_user">Detail Request Timeoff</label>
        <div id="boxx_edit_user">
            ...
            <div id="box3_edit_user">
                <form id="form_box3">
                    ...
                    <label style="margin-bottom: 0px; font-size: 10px; float: left; font-weight: 100">Date Off</label>
                    <input disabled type="text" id="date_off_detail_request" name="date_off_detail_request" required="">                   
            ...
            <div id="box4_edit_user">
                <form id="form_box4">
                    ...
                    <label style="margin-bottom: 0px; font-size: 10px; float: left; font-weight: 100">Total Day</label>
                    <input disabled type="text" id="total_day_detail_request" name="total_day_detail_request" required="" placeholder="Check In">
                    <label style="margin-bottom: 0px; font-size: 10px; float: left; font-weight: 100">Timeoff Code</label>
                    <input disabled type="text" id="timeoff_code_detail_request" name="timeoff_code_detail_request" required="">                   
