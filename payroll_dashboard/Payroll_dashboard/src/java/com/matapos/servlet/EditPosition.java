...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String position_desc = newJson.get("position_desc").toString();

            req.put(FieldParameterMatapos.proccode, ProcessingCode.editposition);
            req.put("company_id", company_id);
            req.put("user_id", user_id);
            req.put("position_id", position_id);
            req.put("position_desc", position_desc);
