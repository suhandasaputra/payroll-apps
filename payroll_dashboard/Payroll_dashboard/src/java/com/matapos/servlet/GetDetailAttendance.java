 ...
 * @author suhan
 */
@WebServlet(name = "GetDetailAttendance", urlPatterns = {"/GetDetailAttendance"})
public class GetDetailAttendance extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getdetailliveattendance);
