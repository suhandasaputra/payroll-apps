 ...
 * @author suhan
 */
@WebServlet(name = "RequestReimbursementRejectHead", urlPatterns = {"/RequestReimbursementRejectHead"})
public class RequestReimbursementRejectHead extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.rejectpengajuanreimbursementhead);
