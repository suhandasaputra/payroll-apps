 ...
 * @author azzam
 */
@WebServlet(name = "EditReligion", urlPatterns = {"/EditReligion"})
public class EditReligion extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String religion_id = newJson.get("religion_id").toString();
            String religion_name = newJson.get("religion_name").toString();

            req.put(FieldParameterMatapos.proccode, ProcessingCode.editreligion);
            req.put("company_id", company_id);
            req.put("user_id", user_id);
            req.put("religion_id", religion_id);
            req.put("religion_name", religion_name);
