 ...
 * @author azzam
 */
@WebServlet(name = "EditPositionLevel", urlPatterns = {"/EditPositionLevel"})
public class EditPositionLevel extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String position_id = newJson.get("add_position_id").toString();
            String position_level = newJson.get("position_level").toString();
            String level_desc = newJson.get("level_desc").toString();

            req.put(FieldParameterMatapos.proccode, ProcessingCode.editlevel);
            req.put("company_id", company_id);
            req.put("user_id", user_id);
            req.put("position_id", position_id);
            req.put("position_level", position_level);
            req.put("level_desc", level_desc);
