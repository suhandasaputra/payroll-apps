 ...
 * @author suhan
 */
@WebServlet(name = "RequestTimeoffRejectHead", urlPatterns = {"/RequestTimeoffRejectHead"})
public class RequestTimeoffRejectHead extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.rejectpengajuantimeoffhead);
