 ...
 * @author azzam
 */
@WebServlet(name = "EditMajority", urlPatterns = {"/EditMajority"})
public class EditMajority extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String majority_id = newJson.get("majority_id").toString();
            String majority_desc = newJson.get("majority_desc").toString();

            req.put(FieldParameterMatapos.proccode, ProcessingCode.editmajority);
            req.put("company_id", company_id);
            req.put("user_id", user_id);
            req.put("majority_id", majority_id);
            req.put("majority_desc", majority_desc);
