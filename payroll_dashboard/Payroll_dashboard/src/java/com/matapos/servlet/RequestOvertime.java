 ...
 * @author azzam
 */
@WebServlet(name = "RequestOvertime", urlPatterns = {"/RequestOvertime"})
public class RequestOvertime extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String start_date = newJson.get("start_date").toString();
            String end_date = newJson.get("end_date").toString();

            req.put(FieldParameterMatapos.proccode, ProcessingCode.getlistpengajuanovertimeadmin);
            req.put("company_id", company_id);
            req.put("start_date", start_date);
