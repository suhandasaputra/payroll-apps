 ...
 * @author suhan
 */
@WebServlet(name = "OptionPosition", urlPatterns = {"/OptionPosition"})
public class OptionPosition extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.optiongetposition);
