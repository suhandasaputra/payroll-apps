 ...
 * @author azzam
 */
@WebServlet(name = "GetDetailPosition", urlPatterns = {"/GetDetailPosition"})
public class GetDetailPosition extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getdetailposition);
