 ...
 * @author suhan
 */
@WebServlet(name = "GetDetailSummary", urlPatterns = {"/GetDetailSummary"})
public class GetDetailSummary extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String tahun = newJson.get("tahun").toString();            
            String company_id = newJson.get("company_id").toString();

            req.put(FieldParameterMatapos.proccode, ProcessingCode.getdetailsummaryabsence);
