 ...
 * @author azzam
 */
@WebServlet(name = "AddPositionLevel", urlPatterns = {"/AddPositionLevel"})
public class AddPositionLevel extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.addlevel);
