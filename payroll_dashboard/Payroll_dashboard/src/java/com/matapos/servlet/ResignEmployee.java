 ...
 * @author azzam
 */
@WebServlet(name = "ResignEmployee", urlPatterns = {"/ResignEmployee"})
public class ResignEmployee extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.closeresign);
