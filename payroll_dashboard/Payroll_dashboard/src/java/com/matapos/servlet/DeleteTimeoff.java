 ...
 * @author azzam
 */
@WebServlet(name = "DeleteTimeoff", urlPatterns = {"/DeleteTimeoff"})
public class DeleteTimeoff extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.deletetimeoff);
