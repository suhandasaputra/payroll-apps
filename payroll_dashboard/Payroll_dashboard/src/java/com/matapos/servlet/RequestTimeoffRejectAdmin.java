 ...
 * @author suhan
 */
@WebServlet(name = "RequestTimeoffRejectAdmin", urlPatterns = {"/RequestTimeoffRejectAdmin"})
public class RequestTimeoffRejectAdmin extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.rejectpengajuantimeoffadmin);
