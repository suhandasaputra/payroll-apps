 ...
 * @author suhan
 */
@WebServlet(name = "RequestApproveAdmin", urlPatterns = {"/RequestApproveAdmin"})
public class RequestApproveAdmin extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.approvepengajuanabsensiadmin);
