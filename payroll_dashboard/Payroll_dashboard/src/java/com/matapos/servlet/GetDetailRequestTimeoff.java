 ...
 * @author suhan
 */
@WebServlet(name = "GetDetailRequestTimeoff", urlPatterns = {"/GetDetailRequestTimeoff"})
public class GetDetailRequestTimeoff extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getdetailpengajuantimeoff);
