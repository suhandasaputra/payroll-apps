 ...
 * @author azzam
 */
@WebServlet(name = "GetListEmployeeCareer", urlPatterns = {"/GetListEmployeeCareer"})
public class GetListEmployeeCareer extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getlistjobuser);
