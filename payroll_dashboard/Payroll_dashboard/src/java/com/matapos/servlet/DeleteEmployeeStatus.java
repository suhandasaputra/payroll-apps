 ...
 * @author azzam
 */
@WebServlet(name = "DeleteEmployeeStatus", urlPatterns = {"/DeleteEmployeeStatus"})
public class DeleteEmployeeStatus extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.deleteemployeestatus);
