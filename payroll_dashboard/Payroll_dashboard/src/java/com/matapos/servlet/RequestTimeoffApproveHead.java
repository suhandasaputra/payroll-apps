 ...
 * @author suhan
 */
@WebServlet(name = "RequestTimeoffApproveHead", urlPatterns = {"/RequestTimeoffApproveHead"})
public class RequestTimeoffApproveHead extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.approvepengajuantimeoffhead);
