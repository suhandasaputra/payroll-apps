 ...
 * @author suhan
 */
@WebServlet(name = "GetDetailRequest", urlPatterns = {"/GetDetailRequest"})
public class GetDetailRequest extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getdetailpengajuanabsensi);
