 ...
 * @author suhan
 */
@WebServlet(name = "OptionLevel", urlPatterns = {"/OptionLevel"})
public class OptionLevel extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String gg = newJson.get("position_id").toString();
            String company_id = newJson.get("company_id").toString();

            req.put("majority", gg);
            req.put("company_id", company_id);
            req.put(FieldParameterMatapos.proccode, ProcessingCode.optiongetlevel);
