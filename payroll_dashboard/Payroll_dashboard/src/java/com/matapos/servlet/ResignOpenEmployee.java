 ...
 * @author azzam
 */
@WebServlet(name = "ResignOpenEmployee", urlPatterns = {"/ResignOpenEmployee"})
public class ResignOpenEmployee extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String employee_id = newJson.get("employee_id_edit_user").toString();

            req.put(FieldParameterMatapos.proccode, ProcessingCode.openresign);
