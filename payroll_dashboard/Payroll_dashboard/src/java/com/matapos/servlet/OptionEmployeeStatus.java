 ...
 * @author suhan
 */
@WebServlet(name = "OptionEmployeeStatus", urlPatterns = {"/OptionEmployeeStatus"})
public class OptionEmployeeStatus extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.optiongetemployeestatus);
