 ...
 * @author suhan
 */
@WebServlet(name = "GetDetailRequestReimbursement", urlPatterns = {"/GetDetailRequestReimbursement"})
public class GetDetailRequestReimbursement extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getdetailpengajuanreimbursement);
