 ...
 * @author suhan
 */
@WebServlet(name = "RequestRejectHead", urlPatterns = {"/RequestRejectHead"})
public class RequestRejectHead extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.rejectpengajuanabsensihead);
