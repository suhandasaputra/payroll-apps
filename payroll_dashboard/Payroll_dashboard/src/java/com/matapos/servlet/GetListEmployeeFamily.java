 ...
 * @author azzam
 */
@WebServlet(name = "GetListEmployeeFamily", urlPatterns = {"/GetListEmployeeFamily"})
public class GetListEmployeeFamily extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getlistfamilyuser);
