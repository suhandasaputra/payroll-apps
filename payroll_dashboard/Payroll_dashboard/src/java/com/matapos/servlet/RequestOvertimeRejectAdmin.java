 ...
 * @author suhan
 */
@WebServlet(name = "RequestOvertimeRejectAdmin", urlPatterns = {"/RequestOvertimeRejectAdmin"})
public class RequestOvertimeRejectAdmin extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.rejectpengajuanovertimeadmin);
