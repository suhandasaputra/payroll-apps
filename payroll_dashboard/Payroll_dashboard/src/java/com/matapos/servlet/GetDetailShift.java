 ...
 * @author azzam
 */
@WebServlet(name = "GetDetailShift", urlPatterns = {"/GetDetailShift"})
public class GetDetailShift extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String shift_id = newJson.get("shift_id").toString();
            String company_id = newJson.get("company_id").toString();
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getdetailshift);

            req.put("shift_id", shift_id);
