 ...
 * @author suhan
 */
@WebServlet(name = "RequestReimbursementRejectAdmin", urlPatterns = {"/RequestReimbursementRejectAdmin"})
public class RequestReimbursementRejectAdmin extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.rejectpengajuanreimbursementadmin);
