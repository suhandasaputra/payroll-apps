 ...
 * @author azzam
 */
@WebServlet(name = "GetDetailEmployeeStatus", urlPatterns = {"/GetDetailEmployeeStatus"})
public class GetDetailEmployeeStatus extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getdetailemployeestatus);
