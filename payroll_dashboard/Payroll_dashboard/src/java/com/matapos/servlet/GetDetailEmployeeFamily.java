 ...
 * @author azzam
 */
@WebServlet(name = "GetDetailEmployeeFamily", urlPatterns = {"/GetDetailEmployeeFamily"})
public class GetDetailEmployeeFamily extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getdetailfamilyuser);
