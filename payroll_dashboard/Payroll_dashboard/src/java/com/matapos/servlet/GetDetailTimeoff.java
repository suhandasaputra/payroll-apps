 ...
 * @author azzam
 */
@WebServlet(name = "GetDetailTimeoff", urlPatterns = {"/GetDetailTimeoff"})
public class GetDetailTimeoff extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getdetailtimeoff);
