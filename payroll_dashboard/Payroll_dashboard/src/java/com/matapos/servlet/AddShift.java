 ...
 * @author azzam
 */
@WebServlet(name = "AddShift", urlPatterns = {"/AddShift"})
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String shift_name = newJson.get("shift_name").toString();
            String start_time = newJson.get("start_time").toString();
            String end_time = newJson.get("end_time").toString();

            req.put(FieldParameterMatapos.proccode, ProcessingCode.addshift);
            req.put("company_id", company_id);
            req.put("user_id", user_id);
            req.put("shift_id", shift_id);
            req.put("shift_name", shift_name);
