 ...
 * @author azzam
 */
@WebServlet(name = "GetDetailSchedule", urlPatterns = {"/GetDetailSchedule"})
public class GetDetailSchedule extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String date = newJson.get("date").toString();
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getdetailschedule);
