 ...
 * @author azzam
 */
@WebServlet(name = "GetDetailMajority", urlPatterns = {"/GetDetailMajority"})
public class GetDetailMajority extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getdetailmajority);
