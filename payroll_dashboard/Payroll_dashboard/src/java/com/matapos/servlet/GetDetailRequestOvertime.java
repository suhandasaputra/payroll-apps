 ...
 * @author suhan
 */
@WebServlet(name = "GetDetailRequestOvertime", urlPatterns = {"/GetDetailRequestOvertime"})
public class GetDetailRequestOvertime extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getdetailpengajuanovertime);
