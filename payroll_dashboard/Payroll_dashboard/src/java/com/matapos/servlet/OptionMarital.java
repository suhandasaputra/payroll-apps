 ...
 * @author suhan
 */
@WebServlet(name = "OptionMarital", urlPatterns = {"/OptionMarital"})
public class OptionMarital extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.optiongetmarital);
