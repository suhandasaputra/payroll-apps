 ...
 * @author suhan
 */
@WebServlet(name = "RequestTimeoffApproveAdmin", urlPatterns = {"/RequestTimeoffApproveAdmin"})
public class RequestTimeoffApproveAdmin extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.approvepengajuantimeoffadmin);
