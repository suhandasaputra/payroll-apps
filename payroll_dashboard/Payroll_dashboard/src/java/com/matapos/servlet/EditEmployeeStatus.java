 ...
 * @author azzam
 */
@WebServlet(name = "EditEmployeeStatus", urlPatterns = {"/EditEmployeeStatus"})
public class EditEmployeeStatus extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String status_id = newJson.get("status_id").toString();
            String status_desc = newJson.get("status_desc").toString();

            req.put(FieldParameterMatapos.proccode, ProcessingCode.editemployeestatus);
            req.put("company_id", company_id);
            req.put("user_id", user_id);
            req.put("status_id", status_id);
            req.put("status_desc", status_desc);
