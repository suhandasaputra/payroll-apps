 ...
 * @author azzam
 */
@WebServlet(name = "DeletePositionLevel", urlPatterns = {"/DeletePositionLevel"})
public class DeletePositionLevel extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteEmployeeStatus</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DeleteEmployeeStatus at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String position_id = newJson.get("position_id").toString();
            String position_level = newJson.get("position_level").toString();

            req.put(FieldParameterMatapos.proccode, ProcessingCode.deletelevel);
