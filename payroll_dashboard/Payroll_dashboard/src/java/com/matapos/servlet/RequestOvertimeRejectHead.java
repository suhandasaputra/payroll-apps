 ...
 * @author suhan
 */
@WebServlet(name = "RequestOvertimeRejectHead", urlPatterns = {"/RequestOvertimeRejectHead"})
public class RequestOvertimeRejectHead extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.rejectpengajuanovertimehead);
