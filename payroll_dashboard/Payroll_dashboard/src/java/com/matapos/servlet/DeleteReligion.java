 ...
 * @author azzam
 */
@WebServlet(name = "DeleteReligion", urlPatterns = {"/DeleteReligion"})
public class DeleteReligion extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.deletereligion);
