 ...
 * @author suhan
 */
@WebServlet(name = "RequestApproveHead", urlPatterns = {"/RequestApproveHead"})
public class RequestApproveHead extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String reference = newJson.get("reference").toString();            
            String company_id = newJson.get("company_id").toString();
            String messages = newJson.get("messages").toString();
            String date_absensi = newJson.get("date_absensi").toString();
            String schema = newJson.get("schema").toString();

            req.put(FieldParameterMatapos.proccode, ProcessingCode.approvepengajuanabsensihead);
            req.put("employee_id", employee_id);
            req.put("user_id", user_id);
            req.put("reference", reference);
            req.put("company_id", company_id);
            req.put("command", messages);
            req.put("date_absensi", date_absensi);
