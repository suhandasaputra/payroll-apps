 ...
 * @author suhan
 */
@WebServlet(name = "OptionMajority", urlPatterns = {"/OptionMajority"})
public class OptionMajority extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.optiongetmajority);
