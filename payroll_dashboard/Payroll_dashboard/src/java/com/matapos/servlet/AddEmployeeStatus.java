 ...
 * @author azzam
 */
@WebServlet(name = "AddEmployeeStatus", urlPatterns = {"/AddEmployeeStatus"})
public class AddEmployeeStatus extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.addemployeestatus);
