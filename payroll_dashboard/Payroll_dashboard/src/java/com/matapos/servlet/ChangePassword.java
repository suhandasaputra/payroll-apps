...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String oldpass = newJson.get("oldpass").toString();
            String user_id = newJson.get("user_id").toString();
            String newpass = newJson.get("newpass").toString();
            String company_id = newJson.get("company_id").toString();

            req.put(FieldParameterMatapos.proccode, ProcessingCode.changepassword);
            req.put("oldpass", oldpass);
            req.put("user_id", user_id);
            req.put("newpass", newpass);
