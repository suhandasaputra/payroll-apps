 ...
 * @author azzam
 */
@WebServlet(name = "AddMajority", urlPatterns = {"/AddMajority"})
public class AddMajority extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.addmajority);
