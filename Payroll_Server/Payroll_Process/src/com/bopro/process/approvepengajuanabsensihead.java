 ...
 * @author suhanda
 */
public class approvepengajuanabsensihead {

    private static Logger log = Logger.getLogger(approvepengajuanabsensihead.class);

    public HashMap process(HashMap input) throws ParseException {
        BackendDBProcess dp = new BackendDBProcess();
        HashMap status = dp.approvepengajuanabsensihead(
